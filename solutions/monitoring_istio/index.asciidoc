...
* istio_requests_total{destination_app="NAME_OF_YOUR_MICROSERVICE"} to get all requests of this microservice 
* sum(irate(istio_requests_total{destination_app="NAME_OF_YOUR_MICROSERVICE"}[60s])) to get the sum of all requests to this microservice, within the last 60sec. 
